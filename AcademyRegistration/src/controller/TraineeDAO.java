...
// 개인 수강 신청 전체 목록
	public void getTraineeTotalList(String sd_num) throws Exception {
		String sql = "select tr.no as no, tr.sd_num as sd_num, tr.l_abbre asl_abbre, le.l_name as l_name, st.sd_name as sd_name, t_section, t_date from trainee tr, lesson le , student st where tr.sd_num = ? and tr.l_abbre = le.l_abbre and tr.sd_num = st.sd_num order by t_date";
